...
public class Portfolio extends JFrame {
	...
	public Portfolio() {
		...
		btnNewButton_1.setBounds(299, 391, 64, 64);
		...
		btnNewButton_10.setIcon(new ImageIcon(Portfolio.class.getResource("/img/logo3.png")));
		btnNewButton_10.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				SorteioEstadio sorteioEstadio = new SorteioEstadio ();
				sorteioEstadio.setVisible(true);
			}
		});
		btnNewButton_10.setToolTipText("SorteioEstadio");
		btnNewButton_10.setBounds(299, 187, 64, 64);
		contentPane.add(btnNewButton_10);
		
		JButton btnCep = new JButton("");
		btnCep.setDefaultCapable(false);
